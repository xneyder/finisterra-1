...
class S3:
    ...
    def aws_s3_bucket_accelerate_configuration(self):
        ...
        for bucket in buckets:
            ...
            if bucket_region == self.region:
                ...
                print(
                    f"  Skipping S3 Bucket Accelerate Configuration (different region): {bucket_name}")
    ...
    def aws_s3_bucket_acl(self):
        ...
        for bucket in buckets:
            ...
            if bucket_region == self.region:
                ...
                print(
                    f"  Skipping S3 Bucket ACL (different region): {bucket_name}")
    ...
    def aws_s3_bucket_cors_configuration(self):
        ...
        for bucket in buckets:
            ...
            if bucket_region == self.region:
                ...
                print(
                    f"  Skipping S3 Bucket CORS Configuration (different region): {bucket_name}")
    ...
    def aws_s3_bucket_intelligent_tiering_configuration(self):
        ...
        for bucket in buckets:
            ...
            if bucket_region == self.region:
                ...
                print(
                    f"  Skipping S3 Bucket Intelligent Tiering Configuration (different region): {bucket_name}")
        ...
        for bucket in buckets:
            ...
            if bucket_region == self.region:
                ...
                for config in inventory_configs["InventoryConfigurationList"]:
                    ...
                    print(
                        f"  Skipping S3 Bucket Inventory (different region): {bucket_name}")
    ...
    def aws_s3_bucket_lifecycle_configuration(self):
        ...
        for bucket in buckets:
            bucket_name = bucket["Name"]
            bucket_region = self.s3_session.get_bucket_location(Bucket=bucket_name)[
                'LocationConstraint']
            if bucket_region == self.region:
                try:
                ...
                print(
                    f"  Skipping S3 Bucket Lifecycle Configuration (different region): {bucket_name}")
    ...
    def aws_s3_bucket_logging(self):
        ...
        for bucket in buckets:
            ...
            if bucket_region == self.region:
                ...
                print(
                    f"  Skipping S3 Bucket Logging (different region): {bucket_name}")
    ...
    def aws_s3_bucket_metric(self):
        ...
        for bucket in buckets:
            ...
            if bucket_region == self.region:
                ...
                print(
                    f"  Skipping S3 Bucket Metrics (different region): {bucket_name}")
    ...
    def aws_s3_bucket_notification(self):
        ...
        for bucket in buckets:
            ...
            if bucket_region == self.region:
                ...
                print(
                    f"  Skipping S3 Bucket Notification (different region): {bucket_name}")
    ...
    def aws_s3_bucket_object(self):
        ...
        for bucket in buckets:
            ...
            if bucket_region == self.region:
                ...
                print(
                    f"  Skipping S3 Bucket Objects (different region): {bucket_name}")
    ...
    def aws_s3_bucket_object_lock_configuration(self):
        ...
        for bucket in buckets:
            ...
            if bucket_region == self.region:
                ...
                print(
                    f"  Skipping S3 Bucket Object Lock Configuration (different region): {bucket_name}")
    ...
    def aws_s3_bucket_ownership_controls(self):
        ...
        for bucket in buckets:
            ...
            if bucket_region == self.region:
                ...
                print(
                    f"  Skipping S3 Bucket Ownership Controls (different region): {bucket_name}")
    ...
    def aws_s3_bucket_policy(self):
        ...
        for bucket in buckets:
            ...
            if bucket_region == self.region:
                ...
                print(
                    f"  Skipping S3 Bucket Policies (different region): {bucket_name}")
    ...
    def aws_s3_bucket_replication_configuration(self):
        ...
        for bucket in buckets:
            ...
            if bucket_region == self.region:
                ...
                print(
                    f"  Skipping S3 Bucket Replication Configuration (different region): {bucket_name}")
    ...
    def aws_s3_bucket_request_payment_configuration(self):
        ...
        for bucket in buckets:
            ...
            if bucket_region == self.region:
                ...
                print(
                    f"  Skipping S3 Bucket Request Payment Configuration (different region): {bucket_name}")
    ...
    def aws_s3_bucket_server_side_encryption_configuration(self):
        ...
        for bucket in buckets:
            ...
            if bucket_region == self.region:
                ...
                print(
                    f"  Skipping S3 Bucket Server Side Encryption Configuration (different region): {bucket_name}")
    ...
    def aws_s3_bucket_website_configuration(self):
        ...
        for bucket in buckets:
            ...
            if bucket_region == self.region:
                ...
                print(
                    f"  Skipping S3 Bucket Website Configuration (different region): {bucket_name}")
